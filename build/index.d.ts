...
declare class ChatGPTAPI {
    ...
    }[], opts?: SendMessageOptions): Promise<ChatMessage>;
    get apiKey(): string;
    set apiKey(apiKey: string);
    get apiOrg(): string;
    set apiOrg(apiOrg: string);
    protected _buildMessages(content: string | {
        type: string;
        text?: string;
        image_url?: {
            url: string;
        };
    }[], opts: SendMessageOptions): Promise<{
...
declare class ChatGPTUnofficialProxyAPI {
    ...
    }[], opts?: SendMessageBrowserOptions): Promise<ChatMessage>;
}
